package com.jessitron.functionalprinciples.functionasvalue;
...
import static com.jessitron.functionalprinciples.functionasvalue.User.user;
...
public class FunctionsByValue {
    ...
    val o = Ordering.by(getFirstName)
